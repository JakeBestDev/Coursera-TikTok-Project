...
not_verififed = data[data['verified_status'] == 'not verified']
verififed = data[data['verified_status'] == 'verified']

not_verififed_mean = not_verififed['video_view_count'].mean()
verififed_mean = verififed['video_view_count'].mean()

print('Not verified mean view count: ' + str(not_verififed_mean))
print('Verified mean view count: ' + str(verififed_mean))

not_verififed['video_view_count'].describe()
...
# 
# Alternitive: There is a difference in number of views between TikTok videos posted by verified accounts and TikTok videos posted by unverified accounts (any observed difference in the sample data is due to an actual difference in the corresponding population means).
...
stats.ttest_ind(a=verififed['video_view_count'] ,b=not_verififed['video_view_count'] , equal_var=False)
